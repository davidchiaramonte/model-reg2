---
- dashboard: example_comparison_dashboard
  title: Example Comparison Dashboard
  layout: newspaper
  ...
  - title: Avg Precision (Copy)
    ...
    width: 2
    height: 4
  - title: Avg F1 Score (Copy)
    name: Avg F1 Score (Copy)
    model: hca_ai_platform
    explore: models
    type: single_value
    fields: [models.dynamic_timeframe, models.average_f1]
